      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Find your <span className="text-zen-purple">flow</span> in a calm, organized space
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <Button className="rounded-full px-8 py-6 bg-white hover:bg-gray-50 text-gray-800 border border-gray-200">
              Watch demo
            </Button>
          </div>
          
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 mb-12 text-sm text-gray-700">
            <div className="flex items-center">
              <Check className="h-4 w-4 text-zen-purple mr-1" />
